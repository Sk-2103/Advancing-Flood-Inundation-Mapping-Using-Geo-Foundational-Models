...
class MaskedAutoencoderViT(nn.Module):
    ...
    def get_intermediate_layers(
        ...
        # cls_token_final = [feat[:, 0, :] for feat in features]
        features = [feat[:, 1:, :] for feat in features]
        
        # target_shape = (16,196, 768)  # [16, 196, 768]
        # expanded_cls_token_final = [token.unsqueeze(1).expand(-1, target_shape[1], -1) for token in cls_token_final]
        
        # combined_features = expanded_cls_token_final +features
